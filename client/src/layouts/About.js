    ...
    <Wrapper>
      <Masthead height="100%" background="#f3f3f3">
        <Box maxwidth="1024px">
          ...
          <MastheadSubtitle>
            We foster the greatest learning tool you have available already-Your
            brain. Our techniques allow you to naturally learn something at the
            highest level possible. No tricks, no gimmicks.
          </MastheadSubtitle>
          <MastheadSubtitle>
            ...
            see that change. But learning a new language is a very difficult and
            hard to become fluent in. We make every endeavor to not make it any
            simpler, but to make it more available and more efficient to learn.
          </MastheadSubtitle>
        </Box>
      </Masthead>
    </Wrapper>
