export default {
  alphabet: {
    consonants: {
      ㄱ: {
        english: {roman: 'pending', spelling: 'ㄱ'},
      ...
      ㄴ: {
        english: {roman: 'pending', spelling: 'ㄴ'},
        korean: {roman: 'n', spelling: 'ㄴ'},
        spanish: {roman: 'pending', spelling: 'pending'},
        french: {roman: 'pending', spelling: 'pending'}
      },
      ㄷ: {
        english: {roman: 'pending', spelling: 'ㄷ'},
      ...
      ㅁ: {
        english: {roman: 'pending', spelling: 'ㅁ'},
        korean: {roman: 'm', spelling: 'ㅁ'},
        spanish: {roman: 'pending', spelling: 'pending'},
        french: {roman: 'pending', spelling: 'pending'}
      },
      ㅂ: {
        english: {roman: 'pending', spelling: 'ㅂ'},
    ...
    vowels: {
      ...
      wa: {
        english: {roman: 'pending', spelling: 'wa'},
        korean: {roman: 'wa', spelling: ''},
        french: {roman: 'pending', spelling: 'pending'}
      },
      weo: {
        english: {roman: 'pending', spelling: 'weo'},
        korean: {roman: 'yeo', spelling: ''},
        french: {roman: 'pending', spelling: 'pending'}
      },
      wo: {
        english: {roman: 'pending', spelling: 'wo'},
        korean: {roman: 'yo', spelling: ''},
        french: {roman: 'pending', spelling: 'pending'}
      },
      wu: {
        english: {roman: 'pending', spelling: 'wu'},
        korean: {roman: 'yu', spelling: ''},
        french: {roman: 'pending', spelling: 'pending'}
      },
      ㅑ: {
