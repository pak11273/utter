...
var hasRightsDirective = function (_SchemaDirectiveVisit) {
  ...
  function hasRightsDirective() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "hasPermission", function () {
      var _ref = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(rules, user, resourceId, expectedRight) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                combinedRules.push(dynamicKeys);
                allPermissions = (0, _lodash.uniq)((0, _lodash.flatten)(combinedRules));
                containsPermission = allPermissions.includes(expectedRight);
