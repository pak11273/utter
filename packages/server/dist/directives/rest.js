...
function (_SchemaDirectiveVisit) {
  _inherits(restDirective, _SchemaDirectiveVisit);

  function restDirective() {
    _classCallCheck(this, restDirective);

    return _possibleConstructorReturn(this, _getPrototypeOf(restDirective).apply(this, arguments));
  }

  _createClass(restDirective, [{
