...
describe("Utils Tests", function () {
  it("Ensure confirms user and clears key in redis", (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee() {
  ...
  it("throws and error if bad key", (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2() {
    var response;
