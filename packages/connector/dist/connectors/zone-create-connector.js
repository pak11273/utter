...
var Z = exports.Z = function (_PureComponent) {
  ...
  function Z() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Z.__proto__ || Object.getPrototypeOf(Z)).call.apply(_ref, [this].concat(args))), _this), _this.submit = function () {
