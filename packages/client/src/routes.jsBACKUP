...
/*   loader: () => import(/1* webpackChunkName: 'about' *1/ "./layouts/about"), */
/*   loading: Loading */
/* }) */
...
/*   loader: () => */
/*     import(/1* webpackChunkName: 'confirm-email' *1/ "./layouts/confirm-email"), */
/*   loading: Loading */
/* }) */

/* const getContact = Loadable({ */
/*   loader: () => import(/1* webpackChunkName: 'contact' *1/ "./layouts/contact"), */
/*   loading: Loading */
/* }) */
...
/*   loader: () => */
/*     import(/1* webpackChunkName: 'courses-created' *1/ "./layouts/courses/containers/courses-created.js"), */
/*   loading: Loading */
/* }) */
...
/* /1* import language from "./data/language.json" *1/ */
